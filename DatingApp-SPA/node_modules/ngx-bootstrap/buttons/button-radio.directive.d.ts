import { ChangeDetectorRef, ElementRef, OnInit, Provider, Renderer } from '@angular/core';
...
export declare class ButtonRadioDirective implements ControlValueAccessor, OnInit {
    ...
    private _value;
    private _disabled;
    constructor(el: ElementRef, cdr: ChangeDetectorRef, group: ButtonRadioGroupDirective, renderer: Renderer);
    onClick(): void;
    ngOnInit(): void;
    onBlur(): void;
