...
export declare class ɵDomRendererFactory2 implements RendererFactory2 {
    ...
    createRenderer(element: any, type: RendererType2 | null): Renderer;
    begin(): void;
    end(): void;
