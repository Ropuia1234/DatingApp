...
export declare class NgStyle implements DoCheck {
    ...
    private _ngStyle;
    private _differ;
    constructor(_ngEl: ElementRef, _differs: KeyValueDiffers, _renderer: Renderer);
    set ngStyle(values: {
        [klass: string]: any;
    } | null);
    ngDoCheck(): void;
